...
/*   Updated: 2023/07/06 22:39:32 by bbonaldi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void printAnimal(AAnimal &animal, std::string idea)
{
	animal.makeSound();
...
void deepCopyTest()
{
	...
	std::cout << YELLOW << (cat1.getBrain() == cat2.getBrain() ? "Shallow Copy" : "Deep Copy") << RESET << std::endl;
	...
	std::cout  << YELLOW << (dog1.getBrain() == dog2.getBrain() ? "Shallow Copy" : "Deep Copy") << RESET << std::endl;
}
