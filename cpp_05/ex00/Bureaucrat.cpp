...
/*   Updated: 2023/07/02 14:24:20 by bbonaldi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << YELLOW << "GradeTooHighException Constructor called" << RESET << std::endl;
}

Bureaucrat::GradeTooHighException::~GradeTooHighException() throw()
{
	std::cout << YELLOW << "GradeTooHighException Destructor called" << RESET << std::endl;
}

const char* Bureaucrat::GradeTooHighException::what() const throw()
{
	std::cerr << "Bureaucrat: " << this->_nameEx << " - tried to set grade for : " << this->_gradeEx << std::endl;
	return "GradeTooHighException: The Max Grade is 1, it cannot be higher than this";
}

Bureaucrat::GradeTooLowException::GradeTooLowException(std::string name, int grade) : _nameEx(name), _gradeEx(grade)
{
	std::cout << YELLOW << "GradeTooLowException Constructor called" << RESET << std::endl;
}

Bureaucrat::GradeTooLowException::~GradeTooLowException() throw()
{
	std::cout << YELLOW << "GradeTooLowException Destructor called" << std::endl;
}

const char* Bureaucrat::GradeTooLowException::what() const throw()
{
	std::cerr << "Bureaucrat: " << this->_nameEx << " - tried to set grade for : " << this->_gradeEx << std::endl;
	return "GradeTooLowException: The Min Grade is 150, it cannot be lower than this";
}
